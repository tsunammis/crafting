...
execution, usually for purposes of cleanup. defer is often used where e.g.
...
// Suppose we wanted to create a file, write to it, and then close when we’re
// done. Here’s how we could do that with defer.
func main() {
