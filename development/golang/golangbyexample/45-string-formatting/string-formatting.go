...
func main() {
	...
	fmt.Printf("%+v\n", p)
	// The %#v variant prints a Go syntax representation of the value, i.e. the
	// source code snippet that would produce that value.
	fmt.Printf("%#v\n", p)
	...
	// formatting use %f.
	fmt.Printf("%f\n", 78.9)
	// %e and %E format the float in (slightly different versions of) scientific
	// notation.
	fmt.Printf("%e\n", 123400000.0)
	fmt.Printf("%E\n", 123400000.0)
