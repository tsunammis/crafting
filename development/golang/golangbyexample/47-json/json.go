...
/*
Go offers built-in support for JSON encoding and decoding, including to and
from built-in and custom data types.
*/
...
func main() {
	...
	// And here are some for slices and maps, which encode to JSON arrays and
	// objects as you’d expect.
	...
	// The JSON package can automatically encode your custom data types. It
	// will only include exported fields in the encoded output and will by
	...
	// JSON key names. Check the definition of Response2 above to see an
	...
	// to their appropriate type. For example here we cast the value in num to
	...
	// of adding additional type-safety to our programs and eliminating the
