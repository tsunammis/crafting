...
/*
Go offers built-in support for regular expressions. Here are some examples of
common regexp-related tasks in Go.
*/
import "bytes"
import "fmt"
import "regexp"
...
func main() {
	...
	// Many methods are available on these structs. Here’s a match test like we
	// saw earlier.
	fmt.Println(r.MatchString("peach"))
	// This finds the match for the regexp.
	fmt.Println(r.FindString("peach punch"))
	// This also finds the first match but returns the start and end indexes for
	// the match instead of the matching text.
	...
	// MustCompile variation of Compile. A plain Compile won’t work for constants
	// because it has 2 return values.
